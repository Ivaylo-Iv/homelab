...
- Expand the README with exact Flux bootstrap commands.
- Add a `docs/` folder with step-by-step bootstrapping and local development instructions.

---

Generated by an automated README update to summarize this repository's structure and deployment flow.
